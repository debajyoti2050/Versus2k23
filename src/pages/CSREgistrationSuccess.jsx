...
const CSREgistrationSuccess = () => {
  ...
  return (
    ...
    <p class="text-center T-text1 mb-4"><span style={{fontWeight:"600"}}><i class="bi bi-telephone-fill"></i> <i class="bi bi-whatsapp"></i>&nbsp;Ankush Ghosh  : </span>9933029283</p>
    <p class="text-center T-text1 mb-4"><span style={{fontWeight:"600"}}><i class="bi bi-telephone-fill"></i> <i class="bi bi-whatsapp"></i>&nbsp;Avay kumar Shaw  : </span>8981691105</p>
...
export default CSREgistrationSuccess